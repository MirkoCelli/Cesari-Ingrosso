            ...
            <table>
                <tr>
                    <td align="center" class="annuale">
                        <a href="<?= $serverpath ?>schemadefault.php" class="">Schemi Ordinativi</a>
                    </td>
                    <td align="center" class="mensile">
                        <a href="<?= $serverpath ?>resetpwd.php" class="" onclick="return confermaCambioPassword();">
                            Reset Password
                        </a>
                ...
                <tr>
                    <td align="center" class="settimanale">
                        <a href="<?= $serverpath ?>settimanale.php" class="">Opzione 3</a>
                    </td>
                    <td align="center" class="giornaliero">
                        <a href="<?= $serverpath ?>giornaliero.php" class="">Opzione 4</a>
                    </td>
                </tr>
                <tr>
                    <td align="center" class="altreopzioni">
                        <a href="<?= $serverpath ?>altreopzioni.php" class="">Opzione 5</a>
                    </td>
                    <td align="center" class="esci">
                        <a href="<?= $serverpath ?>uscito.php" class="">Opzione 6</a>
                    </td>
                </tr>
            </table>
        </center>
