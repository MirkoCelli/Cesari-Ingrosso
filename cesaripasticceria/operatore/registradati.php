...
<html>
 ...
 $idordine = null;
 $nomecliente = "";
 $sql = "SELECT o.id as id, c.Denominazione as nomecliente FROM cp_ordinecliente o JOIN cp_cliente c ON (c.id = o.cliente) WHERE o.cliente = " . $idcliente . " AND o.dataordine = DATE('" . $giorno . "') LIMIT 1 OFFSET 0 ";
...
try{
         ...
         $mail->addAddress('robert@inthenet.sm');
                 ...
                 <tr>
                     <td>
                         <form action="giornaliero.php" method="post">
                             ...
                             <input type="submit" name="submit" id="submit" value="Ritorna" />
                         </form>
                     </td>
