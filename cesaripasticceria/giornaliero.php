...
mysqli_free_result($result);
?>
            <!-- 2025-03-26 - tabellina di riepilogo per gruppi prodotto dell'ordinato di questo giorno particolare per questo cliente -->
            <br />
...
<?php
// 26/03/2025 - Vogliono avere il calcolo per tipologia di prodotto come nel settimanale
                  $giorno1 = $giorno;
