...
<body>
    ...
    <div name="contenuto" class="Contenuti">
        ...
        <center>
            <!--<form action="<?=$serverpath?>confermaschema.php" method="POST" onsubmit="return CheckSubmitFunction(event)">-->
                <table>
                    <tr>
                        <!--
                      <td colspan="3" class="salva">
                      ...
                      <td colspan="7">
                         ...
                         <button id="clona" name="clona" class="clona" onclick="clonareGiornoSettimana()">Clona</button>
                      </td>
                    </tr>
                    <tr>
                        <td align="center"><b>Luned&igrave;</b></td>
                        <td align="center"><b>Marted&igrave;</b></td>
                        <td align="center"><b>Mercoled&igrave;</b></td>
                        <td align="center"><b>Gioved&igrave;</b></td>
                        <td align="center"><b>Venerd&igrave;</b></td>
                        <td align="center"><b>Sabato</b></td>
                        <td align="center"><b>Domenica</b></td>
                    </tr>
<?php
    ...
    if ($igiorno != 1) {
        ...
        if (!$result) {
            ...
            exit; // fine dello script php
                ...
                ?>
                        <form action="<?= $serverpath ?>confermaschema.php?gs=<?=$igiorno?>" method="POST" onsubmit="return CheckSubmitFunction(event)">
                            <table>
                               <tr><td colspan="3" class="salva"><input id="salva" name="salva" type="submit" value="Salva" onclick="return abilitaSubmit()" /></td></tr>
                <?php
                        $indpos = 0;
