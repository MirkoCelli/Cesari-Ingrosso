...
$serverpath1 = ProtocolloHTTP() . $_SERVER["SERVER_NAME"] . PortHTTP($_SERVER["SERVER_PORT"]) . "/cesaripasticceria/"; // . $chperc;
...
$sql = "UPDATE cp_login SET password = PASSWORD2('" . $nuovapwd . "'), primavolta = 1 WHERE id = $indice "; // richiesto da MySQL 8.0
...
$testomail = "Gentile cliente $nomecliente con account utente $utente , <br/>hai richiesto il reset della password: " . $nuovapwd . " è la tua nuova password.<br/> Devi cambiarla subito al prossimo collegamento.";
$emailcliente = $email;
$successo = "";
$errore = "";
...
<head>
  ...
  <body>
     <div class="Contenuti">
         Vi abbiamo inviato una nuova password alla vostra casella E-Mail, da usare al prossimo collegamento come password temporanea.<br />
         Subito dopo, dovrete cambiarla per i collegamenti successivi.<br />
