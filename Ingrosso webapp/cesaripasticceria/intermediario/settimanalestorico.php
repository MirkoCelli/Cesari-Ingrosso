...
// Pagina che gestisce il prospetto settimanale dell'ordinativo del cliente, solo storico senza link a giornaliero.php
                ...
                <tr>
                    ...
                    foreach ($period as $dt) {
                        ...
                        if ($indgiorno > 1) {
                            ?>
                            <td class="date">
                                <!-- <a href="<?= $serverpath ?>giornaliero.php?giorno=<?= $giorno1 ?>&id=<?= $idcln ?>" class=""> -->
                                    <?= $giorno ?>
                                <!-- </a> -->
                            </td>
                            <?php
