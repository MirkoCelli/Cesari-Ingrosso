            ...
            <table class="intesta">
                <tr>
                    <td align="center" class="intestac">
                        <form method="post" action="giornaliero.php">
                            <span id="giornaliero">
                                <input name="giorno" type="date" value="<?= $giorno ?>" required class="data" />
...
?>
                                ...
                                <!--    <button id="aggiungi" name="aggiungi" value="Aggiungi" onclick="return aggiungiRiga()" disabled>Aggiungi</button>  -->
                                </td>
<?php
} else {
?>
                            ...
                            <td colspan="2" class="salva2">
                               <!--    <button id="aggiungi" name="aggiungi" value="Aggiungi" disabled>Aggiungi</button> -->
                            </td>
    <?php
}
?>
    ...
    if ($attivoSalva) {
        ...
        ?>
                                            <button id="openBox_<?=$posizione?>" name="openBox_<?=$posizione?>" onclick="apriInserimento(<?=$posizione?>); return true;" class="openBox" disabled>
                                                <?= $qtaprodotto ?>
                                            </button>
        <?php
    }
...
<!--
                            <td align="right">
                                &#8364; <? = number_format((float) $prezzounit, 2, ',', '') ?>
                            </td>


                            <td align="right">
                                <label id="tot_<? = $posizione ?>" name="tot_<? = $posizione ?>">
