...
<body>
    ...
    <div name="contenuto" class="Contenuti">
        ...
        <center>
            <form action="<?= $serverpath ?>registraschema.php?gs=<?=$gs?>" method="POST">
                <?php
...
?>
    ...
    $sigla1 = SiglaGiornoSettimana($gs);
                    ?>
                        <tr>
                            <td><?=$sigla1?></td>
                        </tr>
...
?>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            // singolo giorno della settimana da gestire
                            $sigla = SiglaGiornoSettimana($gs);
                            // ora disegniamo la tabella riepilogativa dei prodotti con il totale per ogni prodotto e il totale ordine
                            $totaleordine = 0.00;
                            $totaleriga = 0.00;
