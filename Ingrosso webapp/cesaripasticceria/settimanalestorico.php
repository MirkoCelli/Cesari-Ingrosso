...
// Pagina che gestisce il prospetto settimanale dell'ordinativo del cliente ma solo come storico quindi niente link verso giornaliero
...
$sql = "SELECT s.datainizio FROM cp_schemadefault s, cp_login l LEFT OUTER JOIN cp_cliente c ON (c.id = l.codice AND l.tipo = 1) WHERE s.cliente = c.id AND s.datafine IS NULL ";
            ...
            <table>
                <tr>
                    <td align="left" class="intesta">
                        <form method="post" action="settimanalestorico.php">
...
?>
                    ...
                    <td align="center" class="intestac">
                        <form method="post" action="settimanalestorico.php">
                            <span id="settimana">
                                <input name="giorno" type="date" value="<?= $giornata ?>" required class="data" />
            ...
            <table>
                ...
                <tr>
                    ...
                    foreach ($period as $dt) {
                        ...
                        if ($indgiorno > 1) {
                            ?>
                            <td class="date">
                               <!-- <a href="<?= $serverpath ?>giornaliero.php?giorno=<?= $giorno1 ?>" class=""> -->
                                    <?= $giorno ?>
                               <!-- </a>-->
                            </td>
                            <?php
                ...
                <tr>
                    ...
                    foreach ($period as $dt) {
                        ...
                        */
                       // 2024-10-14 - solo giorni antecedenti a domani di $adesso si mostrato i dati, altrimenti il nulla
                       if (substr($adesso,0,10) >= $giorno1)
                       {
