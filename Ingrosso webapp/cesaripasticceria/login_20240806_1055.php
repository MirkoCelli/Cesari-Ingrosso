      ...
      // verifichiamo sul DB che le credenziali siano valide e generiamo il token da mettere nelle cookies per questo utente
        ...
        if (ApriDatabase()){
            ...
            if ($row = mysqli_fetch_array($query)) {
                ...
                $errore = "Utente e/o Credenziali sono errate oppure utente disabilitato";
            }
            ChiudiDatabase();
        } else {
        ...
        <div class="container">
            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="Fornire Utente" name="uname" class="edituser" value="<?=$utente?>" required />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="password" placeholder="Fornire Credenziali" name="psw" class="editpws" required />
                    </td>
                </tr>
                <tr>
                    <td>
                        <button type="submit" class="bottoni">Accedi ></button>
                    </td>
                    <td>
