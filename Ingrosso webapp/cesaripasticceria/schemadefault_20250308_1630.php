                ...
                <table>
                    <tr>
                      <td colspan="7" class="salva">
                          <button id="salva" name="salva" class="clona" onclick="RegistrareDatiSchema();return false;">SALVA</button>&nbsp;&nbsp;
                          ...
                          <button id="clona" name="clona" class="clona" onclick="clonareGiornoSettimana()">COPIA</button>
                      </td>
                    </tr>                    
                    <tr>
   ...
   // 2024-08-18 - qui aggiungiamo un atabella riepilogativa per gruppi prodotti dell'ordinativo previsato per il giorno
                ...
                ?>
                    ...
                    <table class="dettagli1">
                        <tr><td class="dettagli1">Gruppo Prodotti</td><td class="dettagli1">Quantit&agrave;</td><td class="dettagli1">U.M.</td></tr>
                        <?php
...
?>
                        <tr>
                          <td class="dettagli1"><?= $nomegruppo ?></td>
                          <td class="dettagli1"><?= str_replace(",000","",number_format($quantgruppo,3,',')) ?></td>
                          <td class="dettagli1"><?= $umgruppo ?></td>
                        </tr>
<?php
                        }
...
<!--</center>-->
    ...
    <div name="menubasso" class="MenuComandi">
        <a href="<?= $serverpath ?>mainpage.php" class="home" onclick="if (confirm('Avete salvato le modifiche?') == true) { return true; } else { return false; }">HOME</a>
    </div>
</body>
</html>
<?php
