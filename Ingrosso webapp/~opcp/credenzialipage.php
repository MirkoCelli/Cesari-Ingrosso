...
switch ($examp) {
    ...
    case 21:  // INSERT
        ...
        /* -- 06/08/2024 -- la password va sempre indicata oppure viene generata in automatico
        ...
        */
        ...
        $qrystr .= "VALUES ";
        $qrystr .= "($account, ";
        /* -- 06/08/2024 - le password sono registrate in chiaro, se è $password == NULL allora genera una password di 6 cifre numeriche
        if ($password != "" && substr($password,0,1) != "*"){
        ...
        */
        ...
        $password = str_replace("--", "", $password);
        // fine 06/08/2024
        $qrystr .= "'" . $password . "',"; // fine 06/08/2024
        $qrystr .= "$datainizio, $datafine, $annotazioni, $tipo, $codice)";
        $msg .= "\n$qrystr";
    ...
    case 22:	// UPDATE
        ...
        if ($password != "") {
            ...
            $qrystr .= "password = '" . $password . "', "; // 06/08/2024 - le password sono registrate in chiaro
        } else { // genera una password di 6 cifre
            $ii = 6;
            $password = "";
            while ($ii > 0) {
                $password .= strval(rand(0, 9));
