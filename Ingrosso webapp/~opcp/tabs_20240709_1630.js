    ...
    function init() {
      ...
      // Grab the tab links and content divs from the page
        ...
        // alert(tabListItems.length);
        for (var i = 0; i < tabListItems.length; i++) {
         //   alert(i);
         if (tabListItems[i] != null) {
...
function showTab() {
    // alert("ShowTab " + this.getAttribute('href'));
    var selectedId = getHash(this.getAttribute('href'));
    // var selectedId = (this.getAttribute('id'));
      // alert("Selezionato:" + selectedId);
      ...
      return false; // deve seguitare con il link
    }

    function showTab2() {
      var selectedId = getHash( this.getAttribute('href') );
      // alert("Selezionato 2:" + selectedId);
      // Highlight the selected tab, and dim all others.
      // Also show the selected content div, and hide all others.
      for ( var id in sectionDivs ) {
        if ( id == selectedId ) {
    ...
    function showTab3() {
      var selectedId = getHash( this.getAttribute('href') );
      // alert("Selezionato 3:" + selectedId);
      // Highlight the selected tab, and dim all others.
      // Also show the selected content div, and hide all others.
      for ( var id in clienteDivs ) {
        if ( id == selectedId ) {
