...
jQuery("#navgridClienti").jqGrid({
    url:'gruppiprodottopage.php?q=10',
    datatype: "xml",
    colNames:['ID','NOME GRUPPO', 'DESCRIZIONE'],
    colModel:[
        ...
        {name:'nomegruppo',index:'nomegruppo', width:150, align:"left",editable:true,editoptions:{size:15}},
        {name:'descrizione',index:'descrizione', width: 450, editable: true, editoptions: { size: 250 } }],
    rowNum: 25,
...
{reloadAfterSubmit:true,mtype:"POST",url:"gruppiprodottopage.php?q=23",
...
// {},
   ...
   ,addParams: {
        addRowParams: {
            mtype: "POST",
            url: "gruppiprodottopage.php?q=21",
            keys: true,
    ...
    editParams: { mtype: "POST", keys: true, url: "gruppiprodottopage.php?q=22",
                  successfunc: function () {
                      var $self = $(this);
                      setTimeout(function () {
                           $self.trigger("reloadGrid");
